---
title: "Semana 3 y 4: Medidas descriptivas y análisis exploratorio"
format: revealjs
execute:
  echo: true
  warning: false
...
[![](clipboard-1054534539.png){fig-align="center" width="707"}](https://datatab.net/tutorial/location-parameter)
...
[![](clipboard-402400180.png){fig-align="center"}](https://www.investopedia.com/terms/q/quartile.asp)
...
![](Observación-8.png){fig-align="center"}
...
[![Extraído de: https://www.biologyforlife.com/skew.html](clipboard-1551515960.png){fig-align="center"}](https://www.biologyforlife.com/skew.html)
...
![](clipboard-1211324554.png){fig-align="center"}
...
[![](clipboard-1303475039.png){fig-align="center" width="645"}](https://www.kdnuggets.com/2019/11/understanding-boxplots.html)
...
vcd::mosaic(
  ~ continent + nivel,
  data   = gapminder_2007,
  main   = "Relación entre continente y esperanza de vida (2007)"
)
```
...
![Extraído de: https://peltiertech.com/excel-3d-charts-charts-with-no-value/](clipboard-2271837377.png)
...
[ ](clipboard-1893247036.png)\](https://www.simplypsychology.org/correlation.html)
...
![Dirígete a la pestaña Correlación](QR_Code_1745519927.png){fig-align="center" width="85"}
...
Es común encontrar estudios o titulares que afirman que "X causa Y", cuando en realidad lo único que muestran es que ambas variables están correlacionadas. Sin embargo, es fundamental comprender que la **correlación, por sí sola, no implica causalidad**.
...
![La estadítica descriptiva nos permite entender el comportamiento de nuestras variables](Ilustración_sin_título%204.png){fig-align="center" width="594"}
