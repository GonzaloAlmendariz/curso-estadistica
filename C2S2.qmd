---
title: "Semana 2: Comportamiento muestral e inferencia estadística"
format: revealjs
execute:
  echo: false
  warning: false
...
![19 grados de libertad](images/clipboard-3783115314.png){fig-align="center" width="724"}
...
![](images/clipboard-1427679740.png)
...
![](images/Observación-11.png){fig-align="center"}
...
![](images/clipboard-867629982.png){fig-align="center"}
...
En cambio, si el tamaño de la muestra es pequeño, el error estándar será mayor, lo que provoca que las distribuciones sean más anchas y se solapen más, dificultando la diferenciación entre $H_0$ y $H_1$, aumentando la incertidumbre y reduciendo la capacidad de detectar efectos reales cuando estos existen.
...
Ahora, en caso la prueba de Shapiro-Wilk indica que los datos no siguen una distribución normal, una alternativa es utilizar una prueba no parametrica. La pruebas no paramétricas no asumen normalidad en la distribución de tu muestra y cada prueba tiene una versión no paramétrica. En el caso de una prueba para una media, la **prueba de los rangos con signo de Wilcoxon** en lugar de la **prueba t**.
