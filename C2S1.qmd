---
title: "Semana 1: Probabilidad y fundamentos de la inferencia estadística"
format: revealjs
execute:
  echo: false
  warning: false
...
```{r, fig.align='center', fig.height=8, fig.width=20, echo=FALSE}
...
![](images/clipboard-1192708199.png){fig-align="center"}
...
![](images/clipboard-1725739171.png){fig-align="center"}
...
![Extraído de: https://diggingdeeperwithstats.wordpress.com/2021/05/21/visual-guide-to-pnorm-dnorm-qnorm-and-rnorm-functions-in-r/](images/alltogether.webp)
...
```{r, echo= TRUE, warning = FALSE, fig.width = 15, fig.height = 8}
library(tidyverse)
...
[![Extraído de: https://www.allmath.com/central-limit-theorem-calculator.php](images/centrallimit_75.png)
